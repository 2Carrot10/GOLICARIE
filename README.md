Yoinked from `https://github.com/fwg/s-expression` and made slight modification to make it compatible with ES Modules
...
export default function SParse(stream) {
    var parser = new SParse.Parser(stream);
    var expression = parser.expr();
...
// Re-attach the sub-properties to the main function
SParse.Parser = SParser;
